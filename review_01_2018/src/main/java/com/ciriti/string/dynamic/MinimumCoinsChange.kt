...
//    println(minimumNumberCoins(34, L[1,3,4]))
    ...
    minimumNumberCoinsWithValues(34, L[1,3,4])
...
fun minimumNumberCoinsWithValues(money :Int, coins : List<Int>) : Int{

    val initialValue = listOf<Int>()

    val multiMnc = Array(money + 1){ mutableListOf<Int>() }
