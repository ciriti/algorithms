...
fun main() {
  ...
  val module = module {
    ...
    singleton<Singletonable>(
        ::SingletonInjectable
    ) // Will create a single instance, no matter the module

    factory {
      DependingInjectable(
          get(), get()
      )
    } // Example for injection in constructor
  }
  ...
  val module2 = module {
    ...
    factory<Singletonable>(
        ::SingletonInjectable
    ) // For this example, we replace a Singletonable by a Factory
  }
