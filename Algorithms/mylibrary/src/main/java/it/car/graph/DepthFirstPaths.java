...
public class DepthFirstPaths {
    ...
    private void dfs(Graph G, int verticeSuCuiMiTrovo) {
        marked[verticeSuCuiMiTrovo] = true;
        for (int figlioDelVertice : G.adj(verticeSuCuiMiTrovo)) {
            if (!marked[figlioDelVertice]) {
                edgeTo[figlioDelVertice] = verticeSuCuiMiTrovo;
                dfs(G, figlioDelVertice);
            }
        }
    }
